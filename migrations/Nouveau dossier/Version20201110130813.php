 ...
 */
final class Version20201110130813 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pays (idpays INT NOT NULL, nompays VARCHAR(40) NOT NULL, PRIMARY KEY(idpays))');
    }
